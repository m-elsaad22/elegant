...
الإصدار 4.2.0 يطبع زرّي واتساب واتصال دائريين في آخر الصفحة (`#elegant-corner-fabs`) حتى لا يخفيهم ستايل الإضافة ثلاثية الأبعاد. يخفي الشريط العريض والـ FAB القديم لتفادي التكرار.
